                ...
                <form method="POST">
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="help-text">Selecione uma categoria existente ou "Nova Categoria" para criar uma nova</div>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="stock" name="stock" min="0" value="<?php echo $stock ?? '0'; ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-row full">
                        <div class="form-group">
                            ...
                            <textarea id="description" name="description" placeholder="Descreva as características do produto..."><?php echo htmlspecialchars($description ?? ''); ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-row full">
                        <div class="form-group">
                            ...
                            <input type="url" id="image" name="image" value="<?php echo htmlspecialchars($image ?? ''); ?>" placeholder="https://exemplo.com/imagem.jpg">
